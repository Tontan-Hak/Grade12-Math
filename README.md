...
**Topics Covered:**  `.និយមន័យផលគុណពីរវុិចទ័រ` `2.លក្ខណផលគុណពីរវុិចទ័រ` `3.បំណកស្រាយផលគុណនៃពីរវុិចទ័រតាមបែបធរណីមាត្រ` `4.អនុវត្តន៍ផលគុណនៃពីរវុិចទ័រនៅក្នុងរូបវិទ្យា:ម៉ូម៉ង់Mនៃកម្លាំងចំពោះចំណុចP` `5.ផលគុណចម្រុះនៃបីវុិចទ័រក្នុងលំហ`  <br>
