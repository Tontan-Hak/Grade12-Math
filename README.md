...
**Topics Covered:** `ដេរីវេនៃអនុគមន៍ត្រង់ $x_{0}$` `ដេរីវេនៃអនុគមន៍បណ្តាក់` `ដេរីវេនៃអនុគមន៍ត្រីកោណមាត្រ` `ដេរីវេលំដាប់ខ្ពស់`
<br>
**Mathematical Fundamentals:** `Basic algebra` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `អនុគមន៍` `អនុគមន៍ត្រីកោណមាត្រ`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន ៖
...
## Calculus
   ...
   * [ឯកសារបរទេស](https://drive.google.com/file/d/1ZgpXmsO6gJPQuz-b3jCEARz7_eUodmmF/view?usp=sharing)
